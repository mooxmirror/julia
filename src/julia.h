...
#define JL_RETURN_NULL_IF_GCSAFE() do {} while (0)
...
// Return NULL when we are in GC safe mode and the return value can be free'd
// by GC on another thread
#define JL_RETURN_NULL_IF_GCSAFE() do {          \
